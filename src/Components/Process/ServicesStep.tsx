...
function ServicesStep() {
    return (
        <div className="px-4 py-16 mx-auto flex items-center justify-center flex-col gap-8 sm:max-w-xl md:max-w-full lg:w-full  lg:py-20">
            ...
            <div className="grid gap-8 w-[80%] row-gap-0 place-content-center place-items-center lg:grid-cols-3">
                <div className="relative  text-center">
                    ...
                    <p className="max-w-md mb-3 text-sm text-gray-500 sm:mx-auto px-4">
