...
function Banner1() {
    return (
        <div className="relative flex h-full w-full items-center justify-center flex-col gap-8 overflow-hidden bg-background p-20 bg-gradient-to-bl from-indigo-200 via-transparent to-blue-200 mt-10">
            <p className="z-10 w-1/2 whitespace-pre-wrap text-center text-5xl font-bold tracking-tighter text-black dark:text-white">
