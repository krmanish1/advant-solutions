...
function Footer() {
    return (
        <footer className="w-full py-8 bg-gradient-to-r from-blue-950 to-blue-950 hover:bg-gradient-to-b">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto flex flex-col items-center">
                    <Link className="flex items-center justify-center h-28 w-32" href="#">
                        ...
                        <span className="text-white font-bold text-6xl -ml-3 -mt-5">vent</span>
                    </Link>
                    <ul className="text-lg w-full flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 pb-6 mb-10 border-b-2 border-gray-300">
                        <li><a href="#" className="text-gray-100 hover:text-blue-500">About</a></li>
                        <li><a href="#" className=" text-gray-100 hover:text-blue-500">Services</a></li>
                        <li><a href="#" className=" text-gray-100 hover:text-blue-500">contact</a></li>
                    </ul>
                    <div className="flex space-x-10 justify-center items-center mb-8">
                        <a href="#" className="block  text-gray-100 transition-all duration-500 hover:text-blue-500 ">
                    ...
                    <span className="text-lg text-gray-100 text-center block">©<a href="https://pagedone.io/">Advant</a> 2024, All rights reserved.</span>
                </div>
            </div>
        </footer>
    )
